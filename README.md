...
* [Hack My Resume](https://github.com/hacksalot/HackMyResume) ⭐ 9,335 | 🐛 67 | 🌐 JavaScript | 📅 2022-04-03 - Edit a single standard `JSON` file and generate CVs in HTML, Markdown, LaTeX, MS Word, PDF, plain text, JSON, XML, YAML with `JavaScript` libraries.
...
* [FRESH](https://github.com/fresh-standard/fresh-resume-schema) ⭐ 558 | 🐛 21 | 📅 2019-02-08 - `JSON' and `YAML\` standard for resumes.
