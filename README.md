...
* [Markdown CV](https://github.com/elipapa/markdown-cv) ⭐ 1,493 | 🐛 35 | 🌐 CSS | 📅 2024-06-27 - A simple template to write your CV in a readable `Markdown` file and use CSS to publish or print it through the browser.
...
* [Hack My Resume](https://github.com/hacksalot/HackMyResume) ⭐ 9,341 | 🐛 67 | 🌐 JavaScript | 📅 2022-04-03 - Edit a single standard `JSON` file and generate CVs in HTML, Markdown, LaTeX, MS Word, PDF, plain text, JSON, XML, YAML with `JavaScript` libraries.
...
* [LaTeX CV](https://github.com/jankapunkt/latexcv) ⭐ 3,332 | 🐛 1 | 🌐 TeX | 📅 2026-07-31 - Three templates (classic, modern, infographics) with asian languages support.
...
* [resumake](https://github.com/saadq/resumake.io) ⭐ 3,585 | 🐛 90 | 🌐 HTML | 📅 2026-06-26 - Free service that supports the `JSON` resume standard and employs `LaTeX` templates.
