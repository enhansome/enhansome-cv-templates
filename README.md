...
* [Markdown CV](https://github.com/elipapa/markdown-cv) ⭐ 1,495 | 🐛 36 | 🌐 CSS | 📅 2024-06-27 - A simple template to write your CV in a readable `Markdown` file and use CSS to publish or print it through the browser.
...
* [Hack My Resume](https://github.com/hacksalot/HackMyResume) ⭐ 9,342 | 🐛 67 | 🌐 JavaScript | 📅 2022-04-03 - Edit a single standard `JSON` file and generate CVs in HTML, Markdown, LaTeX, MS Word, PDF, plain text, JSON, XML, YAML with `JavaScript` libraries.
...
* [Deedy Resume](https://github.com/deedy/Deedy-Resume) ⭐ 5,047 | 🐛 50 | 🌐 TeX | 📅 2022-09-18 - A one page, two asymmetric column resume template in XeTeX that caters to an undergraduate Computer Science student.
* [LaTeX CV](https://github.com/jankapunkt/latexcv) ⭐ 3,328 | 🐛 1 | 🌐 TeX | 📅 2026-07-31 - Three templates (classic, modern, infographics) with asian languages support.
* [Alta CV](https://github.com/liantze/AltaCV) ⭐ 1,570 | 🐛 11 | 🌐 TeX | 📅 2025-07-30 - Alta CV provides two-columns, infographics, and icons and it is based on the [original Marissa Meyer resume](https://www.businessinsider.com/a-sample-resume-for-marissa-mayer-2015-7/).
...
* [resumake](https://github.com/saadq/resumake.io) ⭐ 3,582 | 🐛 89 | 🌐 HTML | 📅 2026-06-26 - Free service that supports the `JSON` resume standard and employs `LaTeX` templates.
